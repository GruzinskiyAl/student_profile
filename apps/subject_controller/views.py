...
class GroupExamList(View):
    ...
    def get(self, request):
        ...
        return render(
            request, 'exam_list.html', {
                'student': student, 'exam_list': exam_list})
...
class StudentMarkBySubject(View):
    ...
    def get(self, request, subject_pk):
        ...
        return render(
            request, 'subject_marks.html', {
                'student': student, 'marks': marks, 'subject': subject})
...
class StudentMarksChart(View):
    ...
    def get(self, request):
        student = Student.objects.get(user=request.user)
        return render(
            request, 'marks_chart.html', {
                'student': student, 'values': chart_marks_data(student)})
...
class TeacherMessages(View):
    ...
    def get(self, request):
        ...
        messages = TeacherMessage.objects.filter(
            univ_group=student.univ_group)
        return render(
            request, 'teachers_messages.html', {
