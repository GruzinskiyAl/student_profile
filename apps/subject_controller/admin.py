...
admin.site.register(ExamSubjectMark, admin.ModelAdmin)
admin.site.register(StudentSubjectMark, admin.ModelAdmin)
admin.site.register(TeacherMessage, admin.ModelAdmin)
